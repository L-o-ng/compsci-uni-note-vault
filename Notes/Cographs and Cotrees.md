...
![[P4-free graphs.png]]
>[!theorem] A graph $G$ is a **cograph** $\iff$ $G$ is $P_{4}$-free.
## Cotrees
...
>[!theorem] Any cograph $G$ has a unique cotree. If we drop condition 4, there may be many trees representing $G$.
