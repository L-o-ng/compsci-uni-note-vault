...
The worst-case time analysis is a standard way to estimate the efficiency of algorithms - usually, "time complexity" and "worst-case time complexity" are interchangeably used in this way.