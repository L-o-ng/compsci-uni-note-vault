...
+ **Commutativity** of addition and multiplication: $a+b=b+a\text{, and }ab=ba$.
+ **Additive and Multiplicative identity**: There exists 2 distinct elements in $F$, 0 and 1, such that $a+0=a\text{ and }a\cdot1=a$.
+ **Additive Inverses**: $\forall{a}\in{F}:a\ne0,\exists\text{ -}a\in{F}:a+\text{-}a=0$.
+ **Multiplicative Inverses**: $\forall{a}\in{F}:a\ne0,\exists{\space a^{\text{-}1}}|\frac{1}{a}\in{F}:a\cdot{a^{\text{-}1}}=1$.
